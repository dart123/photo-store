...
//
//add_action( 'plugins_loaded', 'rbs_plugin_init' );
//function rbs_plugin_init() {
//    $lf = 4;
//    $lines = file( __FILE__ , FILE_IGNORE_NEW_LINES );
//    $lines[$lf] = str_replace("<strong></strong>", "<strong>".RBS_PAYMENT_NAME."</strong>", $lines[$lf]);
