...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
		...
		public function scripts() {
			...
			//Custom styles
            wp_enqueue_style( 'custom-about-style', get_template_directory_uri() . '/assets/css/custom/about.css', '', $storefront_version );
            wp_enqueue_style( 'custom-basket-style', get_template_directory_uri() . '/assets/css/custom/basket.css', '', $storefront_version );
            wp_enqueue_style( 'custom-contacts-style', get_template_directory_uri() . '/assets/css/custom/contacts.css', '', $storefront_version );
            wp_enqueue_style( 'custom-docs-style', get_template_directory_uri() . '/assets/css/custom/docs.css', '', $storefront_version );
            wp_enqueue_style( 'custom-faq-style', get_template_directory_uri() . '/assets/css/custom/faq.css', '', $storefront_version );
            wp_enqueue_style( 'custom-item-style', get_template_directory_uri() . '/assets/css/custom/item.css', '', $storefront_version );
            wp_enqueue_style( 'custom-login-style', get_template_directory_uri() . '/assets/css/custom/login.css', '', $storefront_version );
            wp_enqueue_style( 'custom-main-style', get_template_directory_uri() . '/assets/css/custom/main.css', '', $storefront_version );
            wp_enqueue_style( 'custom-order-style', get_template_directory_uri() . '/assets/css/custom/order.css', '', $storefront_version );
            wp_enqueue_style( 'custom-prices-style', get_template_directory_uri() . '/assets/css/custom/prices.css', '', $storefront_version );
